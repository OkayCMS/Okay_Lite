...
/* Аяксовая корзина */
$(document).on('submit', '.fn-variants.okaycmslite', function(e) {
	e.preventDefault();
	var variant,
		amount;
	/* Вариант */
...
$(document).on('change', '.fn-variant.okaycmslite', function() {
...
$( document ).on( 'click', '.fn-product-amount.okaycmslite span', function() {
...
$( document ).on( 'keypress', '.fn-coupon.okaycmslite', function(e) {
	if( e.keyCode == 13 ) {
		e.preventDefault();
		ajax_coupon();
	}
...
$( document ).on( 'click', '.fn-sub-coupon.okaycmslite', function(e) {
	ajax_coupon();
} );
...
$(function(){
	...
	$('.fn-slick-banner.okaycmslite').slick({
		infinite: true,
		speed: 500,
		slidesToShow: 1,
		slidesToScroll: 1,
	...
	$(".fn-slick-images.okaycmslite").slick({
		infinite: false,
		speed: 500,
		slidesToShow: 4,
		slidesToScroll: 1,
	...
	$(".fn-slick-carousel.okaycmslite").slick({
		infinite: true,
		speed: 500,
		slidesToShow: 6,
		slidesToScroll: 1,
	...
	if( $( '#fn-slider-price.okaycmslite' ).size() ) {
		...
		$( '#fn-slider-price.okaycmslite' ).slider( {
			range: true,
			min: range_min,
			max: range_max,
		...
		slider_all.on( 'change', function() {
			$( "#fn-slider-price.okaycmslite" ).slider( 'option', 'values', [slider_min.val(), slider_max.val()] );
			ajax_slider();
		} );
	...
	$( ".fn-search.okaycmslite" ).autocomplete( {
