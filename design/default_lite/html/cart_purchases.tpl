				...
				<div class="purchase-list">
					<div class="purchase-row">
						...
						<div class="purchase-amount">
							<div class="fn-product-amount{if $settings->is_preorder} fn-is_preorder{/if} okaycmslite text-xs-center text-md-left">
								{* Кол-во товаров *}
		...
		<div class="purchase-row purchase-main">
			...
			<div class="purchase-name border-b-1-info_md-down form-inline">
				...
				<div class="form-group">
					<input type="text" name="coupon_code" value="{$cart->coupon->code|escape}" class="fn-coupon okaycmslite form-control"/>
				</div>

				<div class="form-group p-l-2">
					<input class="fn-sub-coupon okaycmslite btn btn-success" type="button" value="{$lang->cart_purchases_coupon_apply}">
				</div>
			</div>
			<div class="purchase-price hidden-md-down"></div>
			<div class="purchase-column">
