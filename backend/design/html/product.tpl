            ...
            {foreach $product_variants as $variant}
                <ul>
                    ...
                    <li class="variant_yandex">
                        <input id="ya_input_{$variant->id|escape}" name="yandex[{$variant->id|escape}]" value="1" type="checkbox" {if $variant->yandex}checked=""{/if}/>
                        <label class="yandex_icon" for="ya_input_{$variant->id|escape}"></label>
                    </li>
