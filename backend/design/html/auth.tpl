...
<html>
<title>Административная панель OkayCMS Lite</title>
<link rel="icon" href="design/images/favicon.png" type="image/x-icon">
    <body>
        ...
        <div id="system_logo">
            <img src="design/images/system_logo.png" alt="OkayCMS Lite" />
        </div>
        {if !$manager}
        <h2 class="heading">ВХОД В СИСТЕМУ OKAY CMS LITE</h2>
        {if $error_message}
